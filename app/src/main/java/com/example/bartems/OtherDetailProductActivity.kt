...
class OtherDetailProductActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        goToBarterButton.setOnClickListener {
            val intent = Intent(this@OtherDetailProductActivity, BarterActivity::class.java)
        ...
        goToChat.setOnClickListener {
            val intent = Intent(this@OtherDetailProductActivity, StartChatActivity::class.java)
            startActivity(intent)
        }
        ...
        backDetailProduct.setOnClickListener {
            val intent = Intent(this@OtherDetailProductActivity, HomeActivity::class.java)
            startActivity(intent)
        }
    }
}